                        ...
                        <div className="row">
                                ...
                                <div className="header__logo">
                                    <div className="logo">
                                        <img
                                            ...
                                            src="/upload/iblock/f17/coeba6220qldj5bfpoknvbr8eimvxvek.png@1710344833"
                                            alt=""
                                            width="136"
                                        />
                                    </div>{' '}
                            ...
                            <div className="col d-flex  align-items-center justify-content-end">
                                ...
                                <div className="header__burger">
                                    <button onClick={handleOpenModal} type="button" className="header-burger-button" data-burger-menu title="Переключить меню">
                        ...
                        <nav className="header__navigation" data-main-menu>
                            <ul className="header-navigation__list">
                                <li className="header-navigation__item">
                                    <a href="#countdown" className="header-navigation__link js-anchor">
                                        Промоакции
                                    </a>
                                </li>
                                <li className="header-navigation__item">
                                    <a href="#models" className="header-navigation__link js-anchor">
                                        Авто
                                    </a>
                                </li>
                                <li className="header-navigation__item">
                                    <a href="#calculator-section" className="header-navigation__link js-anchor">
                                        Калькулятор
                                    </a>
                                </li>
                                <li className="header-navigation__item">
                                    <a href="#contacts" className="header-navigation__link js-anchor">
                                        Контакты
                                    </a>
                                </li>
                            </ul>
            ...
            <main className="site-main">
                <section className="index-banner" id="countdown">
                    <div className="index-banner__background">
                        <picture>
                            <source
                                srcSet="/upload/resize_cache/iblock/e08/1440_680_1/zumtvwu9cj3irifyvklxfb3q8896pg8p.jpg, /upload/resize_cache/iblock/e08/1440_680_1/zumtvwu9cj3irifyvklxfb3q8896pg8p.jpg"
                                media="(min-width: 768px)"
                            />
                            <img
                                src="/upload/resize_cache/iblock/e08/1440_680_1/zumtvwu9cj3irifyvklxfb3q8896pg8p.jpg"
                                srcSet="/upload/resize_cache/iblock/e08/1440_680_1/zumtvwu9cj3irifyvklxfb3q8896pg8p.jpg"
                                alt="задний фон"
                                className="index-banner__image"
                            />
                        </picture>
                    </div>
                    <div className="container position-relative">
                        <div className="index-banner__info">
                            <div className="index-banner-info__wrapper">
                                <h1>
                                    Только 7 дней небывалые условия <br /> на покупку Haval
                                </h1>
                                <ul>
                                ...
                                <button
                                    onClick={handleOpenModal}
                                    className="btn btn-primary js-constructor-btn text-uppercase"
                                    data-title="Оставьте заявку и мы Вам перезвоним"
                                    data-name="Акции. Главная страница. "
                                >
                ...
                <section className="models standard-margin-top" id="models">
                        ...
                        <div className="models__list">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval Jolion Новый </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">1 999 000 </div>
                                                </div>
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/b0b/tcm8blszxhzuq1czra6zkzq39qlogv7m.png, /upload/iblock/b0b/tcm8blszxhzuq1czra6zkzq39qlogv7m.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/b0b/576_432_1/tcm8blszxhzuq1czra6zkzq39qlogv7m.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>9,923 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    ...
                                                    <div className="models-item-advantages__name">
                                                        первоначальный
                                                        <br /> взнос
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">1 999 000 </span>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__buttons col-12">
                                                <a
                                                    className="models-item__button -credit btn btn-sm js-anchor-credit js-credit-goal"
                                                ...
                                                <button
                                                    onClick={handleOpenModal}
                                                    className="models-item__button -test-drive btn btn-sm btn-outline-primary js-constructor-btn"
                                                ...
                                                <button
                                                    onClick={handleOpenModal}
                                                    className="models-item__button -sale btn btn-sm btn-primary js-constructor-btn"
                                                    data-title="Оставьте заявку и мы Вам перезвоним"
                            ...
                            <article className="models__item" id="dargo">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval Dargo </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">3 049 000 </div>
                                                </div>
                                                <div className="models-item-price__profit" data-old-price="1">
                                                    <span>
                                                        Выгода до
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/cf0/qoknfk0d21aikq7n0jn6hjffht2qz4j6.png, /upload/iblock/cf0/qoknfk0d21aikq7n0jn6hjffht2qz4j6.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/cf0/576_432_1/qoknfk0d21aikq7n0jn6hjffht2qz4j6.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>16,708 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">3 049 000 </span>
                                                    </div>
                                                </div>
                                                <div className="models-item-price__profit d-flex align-items-center">
                                                    <div className="me-2">
                            ...
                            <article className="models__item" id="haval_h3">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval H3 </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">2 599 000 </div>
                                                </div>
                                                <div className="models-item-price__profit" data-old-price="1">
                                                    <span>
                                                        Выгода до
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/233/0u6v65kww2tuk4qijuji3f4xtpa395nb.png, /upload/iblock/233/0u6v65kww2tuk4qijuji3f4xtpa395nb.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/233/576_432_1/0u6v65kww2tuk4qijuji3f4xtpa395nb.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>16,995 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">2 599 000 </span>
                                                    </div>
                                                </div>
                                                <div className="models-item-price__profit d-flex align-items-center">
                                                    <div className="me-2">
                            ...
                            <article className="models__item" id="haval_f7_новый">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval F7 Новый </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">2 699 000 </div>
                                                </div>
                                                <div className="models-item-price__profit" data-old-price="1">
                                                    <span>
                                                        Выгода до
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/resize_cache/iblock/930/600_388_1/qccdaably07o4dduklw7rjpuzsy43ef4.png, /upload/iblock/930/qccdaably07o4dduklw7rjpuzsy43ef4.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/930/576_432_1/qccdaably07o4dduklw7rjpuzsy43ef4.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>17,649 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">2 699 000 </span>
                                                    </div>
                                                </div>
                                                <div className="models-item-price__profit d-flex align-items-center">
                                                    <div className="me-2">
                            ...
                            <article className="models__item" id="haval_h9">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval H9 </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">4 299 000 </div>
                                                </div>
                                                <div className="models-item-price__profit" data-old-price="1">
                                                    <span>
                                                        Выгода до
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/e5a/22hih0oo38jt1ttg0c1fc0l9xr2k7l3x.png, /upload/iblock/e5a/22hih0oo38jt1ttg0c1fc0l9xr2k7l3x.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/e5a/576_432_1/22hih0oo38jt1ttg0c1fc0l9xr2k7l3x.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>15,656 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">4 299 000 </span>
                                                    </div>
                                                </div>
                                                <div className="models-item-price__profit d-flex align-items-center">
                                                    <div className="me-2">
                            ...
                            <article className="models__item" id="dargo_x">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval Dargo X </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">3 349 000 </div>
                                                </div>
                                                <div className="models-item-price__profit" data-old-price="1">
                                                    <span>
                                                        Выгода до
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/74e/umq7dqmhmx4qyfsjo4k4gp1a6z1hihzm.png, /upload/iblock/74e/umq7dqmhmx4qyfsjo4k4gp1a6z1hihzm.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/74e/576_432_1/umq7dqmhmx4qyfsjo4k4gp1a6z1hihzm.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>18,914 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">3 349 000 </span>
                                                    </div>
                                                </div>
                                                <div className="models-item-price__profit d-flex align-items-center">
                                                    <div className="me-2">
                            ...
                            <article className="models__item" id="haval_f7x">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval F7X </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">2 449 000 </div>
                                                </div>
                                                <div className="models-item-price__profit" data-old-price="1">
                                                    <span>
                                                        Выгода до
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/065/i75muqgr4hyyalpxvjpp6a8hin9ultfb.png, /upload/iblock/065/i75muqgr4hyyalpxvjpp6a8hin9ultfb.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/065/576_432_1/i75muqgr4hyyalpxvjpp6a8hin9ultfb.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>10,547 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">2 449 000 </span>
                                                    </div>
                                                </div>
                                                <div className="models-item-price__profit d-flex align-items-center">
                                                    <div className="me-2">
                            ...
                            <article className="models__item" id="haval_m6">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval M6 </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">2 179 000 </div>
                                                </div>
                                                <div className="models-item-price__profit" data-old-price="1">
                                                    <span>
                                                        Выгода до
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/b79/v0j51u7zdf3guthi8gk2nk0mi4wev0rp.png, /upload/iblock/b79/v0j51u7zdf3guthi8gk2nk0mi4wev0rp.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/b79/576_432_1/v0j51u7zdf3guthi8gk2nk0mi4wev0rp.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>7,651 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">2 179 000 </span>
                                                    </div>
                                                </div>
                                                <div className="models-item-price__profit d-flex align-items-center">
                                                    <div className="me-2">
                            ...
                            <article className="models__item" id="haval_h5">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval H5 </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">3 699 000 </div>
                                                </div>
                                                <div className="models-item-price__profit" data-old-price="1">
                                                    <span>
                                                        Выгода до
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/b8a/812rfjjsbfe3k0b87ei1p2g08fsvjbni.png, /upload/iblock/b8a/812rfjjsbfe3k0b87ei1p2g08fsvjbni.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/b8a/576_432_1/812rfjjsbfe3k0b87ei1p2g08fsvjbni.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>24,188 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">3 699 000 </span>
                                                    </div>
                                                </div>
                                                <div className="models-item-price__profit d-flex align-items-center">
                                                    <div className="me-2">
                            ...
                            <article className="models__item" id="jolion">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval Jolion </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                                    ...
                                                    <div className="models-item-price__old ">1 949 000 </div>
                                                </div>
                                                <div className="models-item-price__profit" data-old-price="1">
                                                    <span>
                                                        Выгода до
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/227/0a231t7pqc5eq556si1b37kyd68qdlux.png, /upload/iblock/227/0a231t7pqc5eq556si1b37kyd68qdlux.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/227/576_432_1/0a231t7pqc5eq556si1b37kyd68qdlux.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>7,063 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                                            ...
                                            <div className="models-item__price ">
                                                <div className="models-item-price__new d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="models-item-price__old ms-2">1 949 000 </span>
                                                    </div>
                                                </div>
                                                <div className="models-item-price__profit d-flex align-items-center">
                                                    <div className="me-2">
                            ...
                            <article className="models__item" id="haval_f7">
                                ...
                                <div className="models-item__row row">
                                    <div className="col-12 col-lg-6 d-flex flex-column justify-content-between">
                                        <div className="models-item__title">
                                            <h3 className="models-item__heading">Haval F7 </h3>
                                        </div>
                                        <div className="models-item__price d-block d-lg-none">
                                            <div className="models-item__price">
                                                <div className="models-item-price__new">
                                        ...
                                        <div className="col-12">
                                            <div className="models-item__gallery">
                                                <div className="models-item__picture">
                                                    <picture>
                                                        <source
                                                            srcSet="/upload/iblock/035/t6y7mrmtb2nrwo0vv0lyxx11nmbw7qeu.png, /upload/iblock/035/t6y7mrmtb2nrwo0vv0lyxx11nmbw7qeu.png 2x"
                                                            media="(min-width: 992px)"
                                                        />
                                                        <img
                                                            className="models-item__image"
                                                            src="/upload/resize_cache/iblock/035/576_432_1/t6y7mrmtb2nrwo0vv0lyxx11nmbw7qeu.png"
                                                            alt=""
                                                            loading="lazy"
                                        ...
                                        <div className="models-item__credit col-12">
                                            <p>
                                                в кредит от <span>10,572 ₽</span> / мес
                                            </p>
                                            <div className="models-item__advantages w-100">
                                                <div className="models-item-advantages__item">
                                                    <div className="models-item-advantages__value">от 0%</div>
                    ...
                    <button
                        onClick={handleOpenModal}
                        className="models__scroll-up"
                        style={{ display: 'none' }}
                        title="Вернуться в начало"
                        data-models-scroll-up
                    >
                        ...
                        <div className="calculator" id="calculator">
                            ...
                            <div className="calculator__row row">
                                ...
                                <div className="col-lg-5 -form p-0">
                                    <form action="#" method="post" autoComplete="off" className="calculator__form needs-validation js-calc-form" noValidate>
                                        ...
                                        <div className="calculator-form__row row">
                                            <div className="calculator-form__item col-sm-6 col-lg-12 form-group">
                                                <label className="form-label" htmlFor="calculator-model">
                                                    Модель
                                                </label>
                                                <select
                                                    value={selectedModel}
                                                    ...
                                                    data-select="carModel"
                                                    data-select-lead="carEquipment"
                                                    data-select-slave="carBrand"
                                                    data-select-fetch
                                                    required
                                                >
                                                    <option value="" data-display="Select"></option>
                                                    <option value="Dargo" data-id="207220">
                                                        Dargo
                                                    </option>
                                                    <option value="Dargo X" data-id="215396">
                                                        Dargo X
                                                    </option>
                                                    <option value="F7" data-id="138300">
                                                        F7
                                                    </option>
                                                    <option value="F7 Новый" data-id="306505">
                                                        F7 Новый
                                                    </option>
                                                    <option value="F7X" data-id="138299">
                                                        F7X
                                                    </option>
                                                    <option value="H3" data-id="304407">
                                                        H3
                                                    </option>
                                                    <option value="H5" data-id="306863">
                                                        H5
                                                    </option>
                                                    <option value="H9" data-id="138301">
                                                        H9
                                                    </option>
                                                    <option value="Jolion" data-id="138354">
                                                        Jolion
                                                    </option>
                                                    <option value="Jolion Новый" data-id="291708">
                                                        Jolion Новый
                                                    </option>
                                                    <option value="M6" data-id="281967">
                                                        M6
                                                    </option>
                                                </select>
                                            </div>
                                            <div className="calculator-form__item col-sm-6 col-lg-12 form-group">
                                                <label className="form-label" htmlFor="calculator-complect">
                                                    Комплектация
                                                </label>
                                                <select
                                                    value={selectedModel}
                                                    onChange={handleChange}
                                                    id="calculator-complect"
                                                    name="property_equipment"
                                                    className="form-control"
                                                    disabled
                                                    data-select="carEquipment"
                                                    data-select-lead="carLoanTerm"
                                                    data-select-slave="carModel"
                                                    required
                                                >
                                                    <option value="" data-display="Select"></option>
                                                </select>
                                            ...
                                            <div className="calculator-form__item col-sm-6 form-group">
                                                <label className="form-label" htmlFor="calculator-first-payment">
                                                    Первый взнос
                                                </label>
                                                <input
                                                    className="form-control"
                                                    id="calculator-first-payment"
                                                    name="property_pay"
                                                    type="text"
                                                    value="0 ₽"
                                                    data-value="1056000"
                                                    data-field="first-payment"
                                                    disabled
                                                    data-max="2376000"
                                                />
                                            </div>
                                            <div className="calculator-form__item col-sm-6 form-group">
                                                <label className="form-label" htmlFor="calculator-term">
                                                    Срок кредитования
                                                </label>
                                                <select
                                                    value={selectedModel}
                                                    ...
                                                    id="calculator-term"
                                                    className="form-control"
                                                    name="property_credit_term"
                                                    data-field="loan-terms"
                                                    data-select="carLoanTerm"
                                                    data-select-slave="carLoanTerm"
                                                    disabled
                                                >
                                                    <option value="" data-display="Select"></option>
                                                    ...
                                                    <option value="96">96 месяцев (8 лет)</option>{' '}
                                                </select>
                                            </div>
                                            <div className="calculator-form__item col-sm-6 form-group">
                                                <label className="form-label" htmlFor="calculator-name">
                                                    Ваше имя
                                                </label>
                                                <input
                                                    className="form-control"
                                            ...
                                            <div className="calculator-form__item col-sm-6 form-group">
                                                <label className="form-label" htmlFor="calculator-user-phone">
                                                    Телефон
                                                </label>
                                                <input
                                                    className="form-control"
                ...
                <section className="trade-in standard-padding-bottom" id="trade-in">
                    ...
                    <div className="container">
                        <h2>
                            Искали, где <span>выгодно обменять</span> автомобиль?
                        </h2>
                        <p>Оставьте заявку и получите выгодное предложение на обмен Вашего старого автомобиля на новый Haval </p>
                        <form action="#" method="post" autoComplete="off" className="form trade-in__form needs-validation js-calc-form" noValidate>
